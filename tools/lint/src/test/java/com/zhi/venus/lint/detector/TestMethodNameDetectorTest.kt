...
package com.zhi.venus.lint.detector

import com.android.tools.lint.checks.infrastructure.TestFiles.kotlin
import com.android.tools.lint.checks.infrastructure.TestLintTask.lint
import com.zhi.venus.tools.lint.TestMethodNameDetector
import org.junit.Test

class TestMethodNameDetectorTest {
    @Test
    fun `detect prefix`() {
        lint().issues(TestMethodNameDetector.PREFIX)
            .files(
                JUNIT_TEST_STUB,
                kotlin(
                    """
    ...
    @Test
    fun `detect format`() {
        lint().issues(TestMethodNameDetector.FORMAT)
            .files(
                JUNIT_TEST_STUB,
                kotlin(
    ...
    private companion object {
        private val JUNIT_TEST_STUB = kotlin(
            """
                package org.junit
